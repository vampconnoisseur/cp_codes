...
void solve()
{
    ...
    while (q--)
    {
        ...
        __int128 D = (__int128)x * x - (__int128)4 * y;
        ...
        ll sqrtD = sqrt((long double)D);

        while ((__int128)sqrtD * sqrtD < D)
            sqrtD++;
        while ((__int128)sqrtD * sqrtD > D)
            sqrtD--;

        if ((__int128)sqrtD * sqrtD != D)
        {
            cout << 0 << " ";
            continue;
        }

        if ((x + sqrtD) % 2 != 0 || (x - sqrtD) % 2 != 0)
        {
            cout << 0 << " ";
            continue;
        }
        ...
        if (r1 == r2)
        {
            auto l = lower_bound(all(a), r1);
            auto r = upper_bound(all(a), r1);
            ll freq = r - l;
        ...
        {
            auto l1 = lower_bound(all(a), r1);
            auto r1_it = upper_bound(all(a), r1);
            ll f1 = r1_it - l1;

            auto l2 = lower_bound(all(a), r2);
            auto r2_it = upper_bound(all(a), r2);
            ll f2 = r2_it - l2;
